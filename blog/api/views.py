...
from blog.serializers import (UserContactSerializer, SliderSerializer, TouchSerializer, HeaderSerializer, MenuSerializer,
                              ServiceSerializer, ServiceHeaderSerializer, ClientSerializer, GuardSerializer, SubscribeSerializer, FooterSerializer,
                              AboutSerializer, InfoSerializer, TeamSerializer, HeaderTouchSerializer, ContactUsSerializer)
