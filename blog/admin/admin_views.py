...
from blog.forms import (HeaderForm, MenuForm, SliderForm, AboutForm, ServiceHeaderForm, ServiceForm, ClientForm, TouchForm,
...
class AdminUpdateView(LoginRequiredMixin, UserPassesTestMixin, UpdateView):
    ...
    def get_object(self):
        return get_object_or_404(CustomUser, id=self.kwargs['user_id'], is_admin=True)
...
class UserUpdateView(LoginRequiredMixin, UpdateView):
    ...
    def form_valid(self, form):
        UserService.update_user(self.object, form)
        return super().form_valid(form)
